...
def test_json_reader():
    ...
    json_path = "test/mdp/unit/mdp_extraction_framework/resources/conf/pipeline.json"
...
def test_overwrite_config():
    ...
    json_path = "test/mdp/unit/framework/mdp_control_framework/resources/conf/pipeline.json"
    input_txt = json.dumps(INPUT_CONFIG, indent=4)
...
def test_read_and_render_config():
    ...
    file_path = "test/mdp/unit/mdp_extraction_framework/resources/conf/sample_config.json"
...
def test_EnvSettings():
    ...
    # assertion for ADLS storage attributes
    assert env_settings.mdp_inbnd.account_name == "testadls001dev"
    assert env_settings.mdp_inbnd.container_name == "test_container"
    assert env_settings.mdp_inbnd.sas_token == "test_token"
    assert env_settings.mdp_inbnd.filepath == "test_adls/filepath"
...
def test_render_with_env_variable():
    ...
    file_path = "test/mdp/unit/mdp_extraction_framework/resources/conf/extraction_config.json"
