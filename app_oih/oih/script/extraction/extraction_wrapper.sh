...
# Start building the command with dynamic project prefix
command="mdp_extraction_framework --project=${project} --scheduler_id=$scheduler_id --pos_dt=$pos_dt --config_file_path=$config_file_path"
